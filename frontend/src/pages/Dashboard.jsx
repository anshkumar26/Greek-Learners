    ...
    <div className="min-h-screen bg-gray-900 text-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 bg-gray-900/80 backdrop-blur-md border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <button onClick={() => navigate('/login')} className="bg-green-400 text-gray-900 px-6 py-2 rounded-full font-semibold hover:bg-green-300 transition">
            Login/SignUp
          </button>
        </div>
      </nav>
      ...
      <section id="booking" className="py-24 px-6 bg-gray-800/50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-900 rounded-3xl p-8 md:p-12 border border-gray-700 space-y-6">
            ...
            {/* Email */}
            <div>
              <label className="block text-sm font-semibold mb-2 items-center">
