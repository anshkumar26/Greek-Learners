    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          {/* Header section with Greek column design */}
          <div className="bg-gradient-to-r from-sky-950 to-sky-700 p-8 text-center relative">
          ...
          <div className="p-8">
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-indigo-500 focus:outline-none transition-colors pr-12"
                    placeholder="••••••••"
                  />
                  <button
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-sky-950 to-sky-700 text-white font-bold py-3 rounded-lg hover:from-sky-950 hover:to-white transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                Sign In
              </button>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center px-4 py-3 border-2 border-gray-200 rounded-lg hover:border-indigo-300 hover:bg-indigo-50 transition-all duration-200">
